...
// 관수 개수 6개 이상 : 
//  1) Node-RED Dashboard 관수 Tab에 그룹 추가 - 그룹이름 : 관수 + 관수번호
//  2) 관수 flow에 관수 정보에 들어가는 Dashboad 위젯 추가 후 flow 설정 및 그룹 설정
//  3) watering.js 코드 수정 - 동적 화면 적용에 추가된 목록의 수만큼 show, hide 수정 
//      ex) 관수 개수 8개 일 때
//          관수7, 관수8 그룹 생성 
//          -> 위젯 추가 
